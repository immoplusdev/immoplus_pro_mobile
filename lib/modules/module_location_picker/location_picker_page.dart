        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: CupertinoSearchTextField(
              autofocus: true,
              onChanged: (value) {
                EasyDebounce.debounce(value, Duration(milliseconds: 300), () {
          ...
          child: Column(children: [
            Visibility(
              ...
              child: Padding(
                ...
                child: ListTile(
                  ...
                  trailing: Icon(CupertinoIcons.chevron_right_circle_fill),
                  leading: Icon(
            ...
            ...currenPredictions
                .map(
                  (e) => ListTile(
                    onTap: () {
                      widget.onSeleted!(fieldsDatails[e.placeId]!,
                          e.primaryText, e.secondaryText, e.fullText);
                    },
                    leading: CircleAvatar(
                    ...
                    subtitle: (e.secondaryText.isNotEmpty)
