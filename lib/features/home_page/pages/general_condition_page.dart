    ...
    return const Scaffold(
      ...
      <body>
        ...
        <li><strong>Email :</strong> contact@afriqsolus.ci</li>
          ...
          <p>ImmoPlus est une application de gestion immobilière conçue pour simplifier votre recherche de propriété immobilière idéale, l'achat de terrains, et la commande de meubles pour votre nouvelle maison. L’application vous permet de commander des meubles pour votre nouvelle maison en quelques clics.</p>
          <p>La présente Politique de confidentialité décrit la façon dont nous collectons, utilisons et partageons des informations personnelles vous concernant tout au long de votre relation avec nous et après la fin de celle-ci.</p>
        ...
        <li><strong>Informations collectées automatiquement :</strong> Informations sur l'appareil (système d’exploitation, adresse IP, etc.)</li>
          ...
          <p>Nous utilisons des cookies et des technologies associées afin de reconnaître votre appareil et de vous fournir des fonctionnalités et des services essentiels, entre autres.</p>
          ...
          <p>Nous supprimons vos informations dans les plus brefs délais, une fois l'objectif de la collecte atteint. Cependant, nous pouvons les conserver pour des raisons légales, réglementaires ou de résolution de litiges.</p>
          ...
          <p>ImmoPlus se réserve le droit de modifier cette politique de confidentialité à tout moment. Les modifications seront communiquées aux utilisateurs via l’application.</p>
