...
class ResidenceGridCard extends StatelessWidget {
  final ResidenceModel residence;
  final VoidCallback onTap;

  const ResidenceGridCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    final bool isDisponible = residence.residenceDisponible;
    final String imageUrl = residence.images.isNotEmpty
