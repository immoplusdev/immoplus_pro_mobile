...
class _WalletProvider implements WalletProvider {
  _WalletProvider(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<WalletResponseModel> getWallet() async {
    ...
    final _options = _setStreamType<WalletResponseModel>(
  ...
  Future<TransactionCollectionModel> getTransactions({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TransactionCollectionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<WithdrawalRequestCollectionModel> getWithdrawalRequest({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WithdrawalRequestCollectionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<WithdrawalRequestModel> createWithdrawalRequest(
    ...
    final _options = _setStreamType<WithdrawalRequestModel>(
  ...
  Future<HasPinResponseModel> hasPin() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HasPinResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/wallet/has-pin',
  ...
  @override
  Future<void> changePin(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> requestPinReset() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> resetPin(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
