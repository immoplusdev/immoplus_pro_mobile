...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, placeId: $placeId, description: $description, alias: $alias, latitude: $latitude, longitude: $longitude)';
  }
...
abstract class _Address implements Address {
  factory _Address(
      ...
      @JsonKey(name: 'alias') String? alias,
      @JsonKey(name: 'latitude') double? latitude,
      @JsonKey(name: 'longitude') double? longitude}) = _$AddressImpl;
