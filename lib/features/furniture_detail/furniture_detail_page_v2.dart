...
class FurnitureDetailPageV2 extends StatefulWidget {
  const FurnitureDetailPageV2({super.key, required this.furnitureId});

  final String furnitureId;

  static const name = 'FURNITURE_DETAIL_PAGE_V2';
  static const routePath = '/furnitures/detail_v2/:id';

  @override
  State<FurnitureDetailPageV2> createState() => _FurnitureDetailPageV2State();
}

class _FurnitureDetailPageV2State extends State<FurnitureDetailPageV2> {
  ...
  void _onEdit(FurnitureModel furniture) {
    context.pushNamed(CreateFurniturePageV2.name, extra: furniture).then((result) {
