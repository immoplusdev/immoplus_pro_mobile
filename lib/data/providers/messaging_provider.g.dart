...
class _MessagingProvider implements MessagingProvider {
  _MessagingProvider(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CreateConversationResponse> createSupportConversation(
    ...
    _data.addAll(body);
    final _options = _setStreamType<CreateConversationResponse>(
  ...
  @override
  Future<List<ConversationModel>> getConversations({String? type}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<ConversationTypeCount>> getConversationCounts() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ConversationTypeCount>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ConversationTypeCount> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ConversationTypeCount.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<HttpResponse<dynamic>> markRead(String conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> blockConversation(String conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> reportConversation(
    String conversationId,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
