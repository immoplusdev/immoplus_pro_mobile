...
class _BannerProvider implements BannerProvider {
  _BannerProvider(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<BannerResponse> getBanners(String source) async {
