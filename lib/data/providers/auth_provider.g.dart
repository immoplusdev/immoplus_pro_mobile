...
class _AuthProvider implements AuthProvider {
  _AuthProvider(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<FileDataModel> uploadImage(File file) async {
    ...
    final _options = _setStreamType<FileDataModel>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
  ...
  Future<AccountCreationResponse> login(LoginBodyModel loginBodyModel) async {
    ...
    final _options = _setStreamType<AccountCreationResponse>(
  ...
  Future<AccountCreationResponse> registrationCustomer(
    CustomerRegistrationBody customRegistrationBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<AccountCreationResponse> registrationEnterprise(
    EnterpriseRegistrationBody enterpriseRegistrationBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<AccountCreationResponse> registrationParticulier(
    ParticulierRegistrationBody particulierRegistrationBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UpdateUserResponseModel> updateUser(
    ...
    final _options = _setStreamType<UpdateUserResponseModel>(
  ...
  Future<UpdateAdditionalDataResponseModel> updateAdditionalData(
    String user,
    UpdateAdditionalDataDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<UpdateAdditionalDataResponseModel>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/action/additional-data/${user}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateAdditionalDataResponseModel _value;
    try {
      _value = UpdateAdditionalDataResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<dynamic>> verifyEmail(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyEmailBody.toJson());
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<HttpResponse<dynamic>> userSendOTP(
    SendEmailOtpBody sendEmailOtpBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<VerifyEmailResponse> verifyOtp(VerifyEmailOtp sendEmailOtpBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> deleteAccount(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ConfigModel> getCongig() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ContactChangeResponse> requestContactChange(
    RequestContactChangeBody body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<ContactChangeResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/request-contact-change',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
