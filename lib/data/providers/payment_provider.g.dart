...
class _PaymentProvider implements PaymentProvider {
  ...
  Future<PaymentItentModel> intentPayment(PaymentIntentBody body) async {
    ...
    final _data = body;
    final _options = _setStreamType<PaymentItentModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<dynamic>> intentPaymentRequest(
      CratePayementRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/payments/action/create-demande-retrait-reservation',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<PaymentsModelCollection> getPayments(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentsModelCollection>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
