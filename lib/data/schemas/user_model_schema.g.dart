...
void _userModelSchemaSerialize(
  ...
  writer.writeString(offsets[3], object.emailEntreprise);
  writer.writeString(offsets[4], object.firstName);
  writer.writeString(offsets[5], object.lastName);
  writer.writeString(offsets[6], object.nomEntreprise);
  writer.writeString(offsets[7], object.phoneNumber);
  writer.writeString(offsets[8], object.photoIdentite);
  writer.writeString(offsets[9], object.pieceIdentite);
  writer.writeString(offsets[10], object.refreshToken);
  writer.writeString(offsets[11], object.roleName);
...
UserModelSchema _userModelSchemaDeserialize(
  ...
  object.emailEntreprise = reader.readStringOrNull(offsets[3]);
  object.firstName = reader.readStringOrNull(offsets[4]);
  object.id = id;
  object.lastName = reader.readStringOrNull(offsets[5]);
  object.nomEntreprise = reader.readStringOrNull(offsets[6]);
  object.phoneNumber = reader.readStringOrNull(offsets[7]);
  object.photoIdentite = reader.readStringOrNull(offsets[8]);
  object.pieceIdentite = reader.readStringOrNull(offsets[9]);
  object.refreshToken = reader.readStringOrNull(offsets[10]);
  object.roleName = reader.readStringOrNull(offsets[11]);
