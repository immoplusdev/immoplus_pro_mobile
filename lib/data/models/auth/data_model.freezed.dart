...
class _$DataModelImpl implements _DataModel {
  const _$DataModelImpl(
      {required this.user, this.accessToken, this.expires, this.refreshToken});
  ...
  @override
  String toString() {
    return 'DataModel(user: $user, accessToken: $accessToken, expires: $expires, refreshToken: $refreshToken)';
  }
...
abstract class _DataModel implements DataModel {
  const factory _DataModel(
      ...
      final String? accessToken,
      final String? expires,
      final String? refreshToken}) = _$DataModelImpl;
