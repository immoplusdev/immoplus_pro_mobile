...
abstract class $OperatorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String name, String value, String logo, String prefix, int fee});
}
...
class _$OperatorModelImpl implements _OperatorModel {
  ...
  @override
  String toString() {
    return 'OperatorModel(id: $id, name: $name, value: $value, logo: $logo, prefix: $prefix, fee: $fee)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, value, logo, prefix, fee);
...
abstract class _OperatorModel implements OperatorModel {
  const factory _OperatorModel(
      ...
      final String logo,
      final String prefix,
      final int fee}) = _$OperatorModelImpl;
